...
\subtitle{Funções Polinomiais}  % could also be a conference name
...
\begin{Teo}[Teorema Fundamental da Proporcionalidade]
...
\begin{frame}
\frametitle{Funções Polinomiais} %\framesubtitle{Exemplos}
\begin{Prop}[Fórmula de Interpolação de Lagrange]
